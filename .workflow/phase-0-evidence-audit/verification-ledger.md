...
| --- | --- | --- | --- | --- | --- | --- |
| VERIFY-P0-001 | Phase 0 exit | baseline.json | file present + valid JSON | committed | committed in `b482c0d`; valid JSON (fix_commits n=255, time_to_merge n=170); `git ls-files baseline.json` confirms tracked | pass |
